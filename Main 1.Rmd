...
ggplot(raw, aes(GROUP, Ch1.Mean.)) + geom_col() + facet_wrap(~raw$EXPT)
ggplot(raw, aes(GROUP, Ch2.Mean.)) + geom_col() + facet_wrap(~raw$EXPT)
ggplot(raw, aes(GROUP, Ch3.Mean.)) + geom_col() + facet_wrap(~raw$EXPT)
ggplot(raw, aes(GROUP, Ch4.Mean.)) + geom_col() + facet_wrap(~raw$EXPT)
