...
rawkk_long = melt(rawkk, id.vars=names(rawkk[1:12]), variable.name = "CHANNEL", value.name="DENSITY")

ggplot(rawkk_long) + aes(GROUP, DENSITY, fill=EXPT, color = EXPT) + facet_wrap(~CHANNEL, scales="free") +
