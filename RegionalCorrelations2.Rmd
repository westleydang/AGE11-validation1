...
cor1 = cor(a[,2:75], a[,2:75], use=use.method, method=corr.type)
...
cor1 = cor(a[,2:75], a[,2:75], use=use.method, method=corr.type)
corrplot(cor1, method="color", order=cluster.method, tl.cex=0.4, title="all young", mar=c(0,0,1,0))
...
cor1 = cor(a[,2:75], a[,2:75], use=use.method, method=corr.type)
corrplot(cor1, method="color", order=cluster.method, tl.cex=0.4, title="all old", mar=c(0,0,1,0))
...
cor1 = cor(a[,2:75], a[,2:75], use=use.method, method=corr.type)
corrplot(cor1, method="color", order=cluster.method, tl.cex=0.4, title="all AA", mar=c(0,0,1,0))
...
cor1 = cor(a[,2:75], a[,2:75], use=use.method, method=corr.type)
corrplot(cor1, method="color", order=cluster.method, tl.cex=0.4, title="all AB", mar=c(0,0,1,0))
...
cor1 = cor(a[,2:75], a[,2:75], use=use.method, method=corr.type)
corrplot(cor1, method="color", order=cluster.method, tl.cex=0.4, title="all shock h2b", mar=c(0,0,1,0))
...
cor1 = cor(a[,2:75], a[,2:75], use=use.method, method=corr.type)
corrplot(cor1, method="color", order=cluster.method, tl.cex=0.4, title="all context h2b", mar=c(0,0,1,0))
